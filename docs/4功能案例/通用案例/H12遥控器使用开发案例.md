...
cd <代码仓库>/src/humanoid-control/h12pro_controller_node/scripts
sudo su
./deploy_autostart.sh
```
...
- VR 录制指定的话题配置文件存放在 `<代码仓库>/src/humanoid-control/h12pro_controller_node/config/record_topics.json` 路径下
- 指定录制的话题如下：
