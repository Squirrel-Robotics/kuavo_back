...
- [H12遥控器使用开发案例](#h12遥控器使用开发案例)
  - [1. 部署流程](#1-部署流程)
    - [1.1 执行部署脚本](#11-执行部署脚本)
    - [1.2 H12PRO 遥控器服务管理](#12-h12pro-遥控器服务管理)
    - [1.3 查看机器人程序运行 LOG](#13-查看机器人程序运行-log)
    - [1.4 检查遥控器数据是否正常](#14-检查遥控器数据是否正常)
    - [1.5 注意事项](#15-注意事项)
  - [2. 状态机概述](#2-状态机概述)
    - [2.1 基本状态](#21-基本状态)
    - [2.2 状态转换流程图](#22-状态转换流程图)
  - [3. 遥控器配置](#3-遥控器配置)
    - [3.1 按键示意图](#31-按键示意图)
    - [3.2 状态转换按键组合](#32-状态转换按键组合)
      - [Initial (机器人 NUC 开机， 程序未启动状态) 状态转换](#initial-机器人-nuc-开机-程序未启动状态-状态转换)
      - [Ready\_stance (启动机器人程序后，尚未站立的状态) 状态转换](#ready_stance-启动机器人程序后尚未站立的状态-状态转换)
      - [Calibrate (启动机器人程序带上校正参数的状态)状态转换](#calibrate-启动机器人程序带上校正参数的状态状态转换)
      - [Stance 状态转换](#stance-状态转换)
      - [Walk 状态转换](#walk-状态转换)
      - [VR\_remote\_control 状态转换](#vr_remote_control-状态转换)
    - [3.2 摇杆配置](#32-摇杆配置)
      - [左摇杆](#左摇杆)
      - [右摇杆](#右摇杆)
    - [3.3 紧急停止](#33-紧急停止)
