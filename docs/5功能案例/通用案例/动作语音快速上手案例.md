...
```
工具会自动:
- 下载语音文件到`/home/kuavo/.config/lejuconfig/voice_files`
...
# 选择 2: 自定义动作文件设置
```
- 将语音文件(.mp3/.wav)放入`/home/kuavo/.config/lejuconfig/voice_files`
...
2. 文件路径:
   ...
   - 上位机语音文件: `/home/kuavo/.config/lejuconfig/voice_files`
