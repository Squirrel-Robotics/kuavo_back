...
- [🤖 机器人模仿学习全流程](#-机器人模仿学习全流程)
  - [🔧 环境配置](#-环境配置)
    ...
    - [♻️ 环境要求](#️-环境要求)
    - [📦 安装指南](#-安装指南)
      - [1. 操作系统环境配置](#1-操作系统环境配置)
        - [a. 安装操作系统与 NVIDIA 驱动](#a-安装操作系统与-nvidia-驱动)
        - [b. 安装 NVIDIA Container Toolkit](#b-安装-nvidia-container-toolkit)
        - [c. 安装 Docker](#c-安装-docker)
      - [2. ROS 环境配置](#2-ros-环境配置)
      - [3. 克隆代码](#3-克隆代码)
  ...
  - [📨 kuavo\_data\_challenge 使用方法](#-kuavo_data_challenge-使用方法)
    ...
    - [2. 模仿学习训练](#2-模仿学习训练)
      - [配置文件](#配置文件-1)
      - [2.1 模仿学习训练：单机多卡模式](#21-模仿学习训练单机多卡模式)
      - [配置文件](#配置文件-2)
    - [3. 真机模型部署](#3-真机模型部署)
      - [配置文件](#配置文件-3)
      - [3.1 硬件启动](#31-硬件启动)
      - [3.2 真机推理部署脚本](#32-真机推理部署脚本)
      - [3.3 真机异步推理](#33-真机异步推理)
    - [4. 推理效果调优](#4-推理效果调优)
      - [4.1 同步推理](#41-同步推理)
      - [4.2 异步推理](#42-异步推理)
      - [4.3 模型输出与动作平滑](#43-模型输出与动作平滑)
    - [5. 说明](#5-说明)
      - [📡 ROS 话题说明](#-ros-话题说明)
      - [📁 代码输出结构](#-代码输出结构)
      - [📂 核心代码结构](#-核心代码结构)
- [🔬 科研场景实现](#-科研场景实现)
  - [🍸 莫吉托酒调制 -- 长程任务拆解能力{#Cocktail\_Making}](#-莫吉托酒调制----长程任务拆解能力cocktail_making)
    - [🏠 场景介绍](#-场景介绍)
    - [🖥️ 系统环境](#️-系统环境)
    - [📦 场景所需物品](#-场景所需物品)
    - [🚀 整体流程](#-整体流程)
      ...
      - [模型训练](#模型训练)
      - [模型推理](#模型推理)
  - [🍎 果蔬分拣 -- 模型泛化能力{#Fruit\_Vegetable\_Sorting}](#-果蔬分拣----模型泛化能力fruit_vegetable_sorting)
    - [🏠 场景介绍](#-场景介绍-1)
    - [🖥️ 系统环境](#️-系统环境-1)
    - [📦 场景所需物品](#-场景所需物品-1)
    - [🚀 整体流程](#-整体流程-1)
...
| -- | -- |
| <img src="./images/1.gif" height="280"/> | <img src="./images/0.gif" height="280"/> |
