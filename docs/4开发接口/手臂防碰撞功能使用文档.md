# 手臂防碰撞功能使用文档 kuavo_arm_collision_check

- [手臂防碰撞功能使用文档 kuavo\_arm\_collision\_check](#手臂防碰撞功能使用文档-kuavo_arm_collision_check)
  - [功能包说明](#功能包说明)
  - [注意事项](#注意事项)
  - [启动方式](#启动方式)
...
- 文件位置如下,请根据您的机器版本选择:(若不清楚, 可在下位机终端输入`echo $ROBOT_VERSION`查询)
  - 45版本:`<kuavo-ros-opensource>/src/kuavo_arm_collision_check/config/s45_collision_config.yaml`
  - 49版本:`<kuavo-ros-opensource>/src/kuavo_arm_collision_check/config/s49_collision_config.yaml`
- 编辑文件, 将文件结尾添加如下内容即可
```yaml
ignore_links:
  - l_hand_tripod
