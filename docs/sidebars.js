  ...
  tutorialSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        'basic_usage/kuavo-ros-control/docs/3开发接口/sdk_use',
      ],
    },
    {
      type: 'category',
      ...
      items: [
        {
          ...
          items: [
            ...
            'basic_usage/kuavo-ros-control/docs/4功能案例/通用案例/单步控制案例(落足点规划)',
        ...
        },
        {
          ...
          items: [
            ...
            'basic_usage/kuavo-ros-control/docs/4功能案例/拓展案例/机器人导航',
          ],
        },
