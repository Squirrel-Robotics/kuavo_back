...
class VisionBasedStairClimbingPlanner:
    ...
    def plan_stair_climbing(self, distance_to_first_step, points):
        ...
        try:
            ...
            if self.first_received:
                safe_distance = 0.355 # 半截楼梯宽度0.15 + 脚尖到base的距离0.15左右 + 距离楼梯前边缘安全距离
                if distance_to_first_step > safe_distance: 
                    ...
                    time_traj, foot_idx_traj, foot_traj, torso_traj, swing_trajectories = self.planner.plan_move_to_world(
                        ...
                        modify_current_x=points[0][0] - distance_to_first_step
                    )
            ...
            # 发布轨迹
            self.publish_world_trajectory(time_traj, foot_idx_traj, foot_traj, torso_traj, swing_trajectories)
    ...
    def publish_world_trajectory(self, time_traj, foot_idx_traj, foot_traj, torso_traj, swing_trajectories):
        """发布轨迹到控制器"""
        if self.debug_mode:
