...
class EEForceControlGUI(QMainWindow):
    def __init__(self):
        ...
        # 挥空检测开关话题
        self.pub_force_empty_detact = rospy.Publisher('/enable_force_empty_detact', Bool, queue_size=10)
    ...
    def _publish_force(self, hand, force):
        ...
        # 将 kg 转换为 N: 1kg = 9.8N
        msg.wrench.force.x = force['x'] * self.gravity
        msg.wrench.force.y = force['y'] * self.gravity
        msg.wrench.force.z = force['z'] * self.gravity
        msg.wrench.torque.x = msg.wrench.torque.y = msg.wrench.torque.z = 0.0
        (self.pub_left if hand == 'left' else self.pub_right).publish(msg)
    ...
    def toggle_force_empty_detact(self):
        ...
        self.pub_force_empty_detact.publish(Bool(data=self.force_empty_detact_enabled))
